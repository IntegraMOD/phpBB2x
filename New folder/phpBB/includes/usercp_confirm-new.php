...
if($size[2] == IMAGETYPE_JPEG) $img = imagecreatefromjpeg($file_name);
elseif($size[2] == IMAGETYPE_PNG) $img = imagecreatefrompng($file_name);
elseif($size[2] == IMAGETYPE_GIF) $img = imagecreatefromgif($file_name);
