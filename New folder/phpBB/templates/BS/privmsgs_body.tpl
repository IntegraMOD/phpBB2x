...
<div class="container-fluid">
  ...
  <div class="container-fluid">
    <div class="row">
	  ...
	  <div class="col-3 bodyline row1 rounded-2 bdr-dk">
        <div class="row py-1">
  ...
  <div class="row mx-0 mb-2">
    <div class="col py-1 pl-0 d-flex nw gen"><button class="pbtn bg-secondary-subtle btn-sm bdr-cat btnwrapper navbr" type="button" alt=""><i class="fa-solid fa-pen-to-square"></i>&nbsp;{POST_PM}</button></div>
  ...
  <div class="p-2 text-center bg-light rounded-2 bdr-lt boxwrapper">
	<div class="row nav mx-0 pl-2 pb-1 d-flex flex-row align-items-center"> 
      <div class="col-1 pl-1 py-1 text-center">{L_FLAG}</div>
      <div class="col-6 p-0 py-1 ml-0 text-start">{L_SUBJECT}</div>
      <div class="col-2 p-0 py-1 text-center">{L_FROM_OR_TO}</div>
      <div class="col-2 p-0 py-1 text-center">{L_DATE}</div>
      <div class="col-1 p-0 py-1 text-center">{L_MARK}</div>
	</div>
	<!-- BEGIN listrow -->
	<div class="row d-flex bg-body-secondary rounded-2 bdr-cat align-items-center py-1 mx-0 my-1"> 
      <div class="col-1 pl-1 py-1 text-center {listrow.ROW_CLASS}"><img src="{listrow.PRIVMSG_FOLDER_IMG}" width="19" height="18" alt="{listrow.L_PRIVMSG_FOLDER_ALT}" title="{listrow.L_PRIVMSG_FOLDER_ALT}" /></div>
      ...
      <div class="col-2 p-0 py-1 text-center {listrow.ROW_CLASS} genbig"><a href="{listrow.U_FROM_USER_PROFILE}" class="genbig">{listrow.FROM}</a></div>
      <div class="col-2 p-0 py-1 text-center {listrow.ROW_CLASS} postdetails">{listrow.DATE}</div>
      <div class="col-1 p-0 py-1 text-center {listrow.ROW_CLASS} postdetails"><input type="checkbox" name="mark[]2" value="{listrow.S_MARK_ID}" /></div>
	</div>
	<!-- END listrow -->
    ...
    <div class="row">{S_HIDDEN_FIELDS} 
      ...
      <div class="col pt-1 ctr"><input type="submit" name="delete" value="{L_DELETE_MARKED}" class="mainoption" /></div>
      <div class="col pt-1 ctr"><input type="submit" name="deleteall" value="{L_DELETE_ALL}" class="mainoption" /></div>
	</div>
  </div>
  <div class="row mx-0 mt-2 pb-2">
    <div class="col py-1 pl-0 d-flex nw gen"><button class="pbtn bg-secondary-subtle btn-sm bdr-cat btnwrapper navbr" type="button" alt=""><i class="fa-solid fa-pen-to-square"></i>&nbsp;{POST_PM}</button></div>
