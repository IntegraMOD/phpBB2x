...
{
    $rand_str = bin2hex(random_bytes(16)); // Generate a cryptographically secure random string

    return ($hash) ? password_hash((string) $rand_str, PASSWORD_BCRYPT) : substr((string) $rand_str, 0, 8);
}
