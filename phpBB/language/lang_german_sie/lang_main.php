...
$lang['Confirm_code_impaired'] = 'Wenn Sie visuell beeinträchtigt sind oder aus einem anderen Grund den Code nicht lesen können, kontaktieren Sie bitte den %sAdministrator%s für Hilfe.';
$lang['Confirm_code'] = 'Bestätigungs-Code';
$lang['Confirm_code_explain'] = 'Geben Sie den Code exakt so ein, wie Sie ihn siehen. Der Code unterscheidet zwischen Groß- und Kleinschreibung, die Null hat im Inneren einen schrägen Strich.';
