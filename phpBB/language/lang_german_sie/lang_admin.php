...
$lang['Ban_username_explain'] = 'Mit einer Kombination aus Tastatur und Maus können Sie auch mehrere Benutzer auf einmal bannen';
...
// Version Check
//
$lang['Version_up_to_date'] = 'Ihre Installation ist auf dem neusten Stand. Für diese Version von phpBB sind keine Updates verfügbar.';
$lang['Version_not_up_to_date'] = 'Ihre Installation scheint <b>nicht</b> auf dem neusten Stand zu sein. Für diese Version von phpBB stehen Updates bereit. Besuchen Sie bitte <a href="http://www.phpbb.com/downloads.php" target="_new">http://www.phpbb.com/downloads.php</a>, um die neueste Version zu erhalten.';
$lang['Latest_version_info'] = 'Die neuste verfügbare Version ist <b>phpBB %s</b>.';
$lang['Current_version_info'] = 'Sie benutzen momentan <b>phpBB %s</b>.';
$lang['Connect_socket_error'] = 'Kann den phpBB-Server nicht erreichen. Folgende Fehlermeldung wurde übermittelt:<br />%s';
$lang['Socket_functions_disabled'] = 'Die Socket-Funktionen stehen nicht zur Verfügung.';
$lang['Mailing_list_subscribe_reminder'] = 'Um die aktuelle Informationen über Updates für phpBB zu erhalten, empfielt es sich <a href="http://www.phpbb.com/support/" target="_new">unsere Mailing-Liste zu abbonieren</a>.';
$lang['Version_information'] = '<a href="#" onclick="toggle_visibility( \'ver\' );" title="Versionsinformationen">Versionsinformationen</a>';
