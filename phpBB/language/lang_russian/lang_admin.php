...
$lang['Ban_Management'] = 'Чёрные списки';
...
$lang['Board_disable_explain'] = 'Форумы станут недоступными пользователям. Администраторы могут зайти на форум, воспользовавшись Панелью Администрирования';
...
$lang['Visual_confirm_explain'] = 'Требует от пользователя введения кода подтверждения, указанного на картинке, при регистрации.';

// Autologin Keys - added 2.0.18
$lang['Allow_autologin'] = 'Разрешать автоматический вход';
$lang['Allow_autologin_explain'] = 'Разрешать ли пользователям указывать, хотят ли они автоматически вхотидь при каждом посещении форума.';
$lang['Autologin_time'] = 'Срок устаревания ключа автоматического входа';
$lang['Autologin_time_explain'] = 'Сколько дней после посещения форума будет действовать автоматический вход. Для отключения этого ограничения укажите 0 (ноль).';
...
$lang['Stylesheet_explain'] = 'Имя файла стилей CSS.';
