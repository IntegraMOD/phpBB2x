...
$lang['Board_disable'] = 'Извините, эти форумы отключены. Попробуйте зайти через некоторое время.';
...
//
$lang['Confirm_code_wrong'] = 'Введенный Вами код подтверждения неверен.';
$lang['Too_many_registers'] = 'Вы совершили слишком много попыток регистрации пользователей. Попробуйте повторить позднее.';
$lang['Confirm_code_impaired'] = 'Если Вы не можете по каким-либо причинам распознать код подтверждения, пожалуйста, обратитесь за помощью к %sАдминистратору%s.';
$lang['Confirm_code'] = 'Код подтверждения';
$lang['Confirm_code_explain'] = 'Пожалуйста введите код, отображенный на рисунке. Код является регистро-зависимым.';
...
$lang['Admin_reauthenticate'] = 'Для перехода в режим администрирования Вам необходимо повторно авторизоваться.';
