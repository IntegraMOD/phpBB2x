	...
	$count++;
		...
		else
		{
			...
			$template->assign_vars(array(
				...
				"L_DIV_CLASS_1" => ($lang['div_class1'] ?? null),
				"L_DIV_CLASS_2" => ($lang['div_class2'] ?? null),
				"L_DIV_CLASS_3" => ($lang['div_class3'] ?? null),				
				"L_ROW_CLASS_1" => ($lang['row_class1'] ?? null),
				"L_ROW_CLASS_2" => ($lang['row_class2'] ?? null),
				"L_ROW_CLASS_3" => ($lang['row_class3'] ?? null),				
				"L_COL_CLASS_1" => ($lang['col_class1'] ?? null),
				"L_COL_CLASS_2" => ($lang['col_class2'] ?? null),
				"L_COL_CLASS_3" => ($lang['col_class3'] ?? null),				
