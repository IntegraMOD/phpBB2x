...
class emailer
{
	...
	function send()
	{
		...
		$cc = (isset($this->addresses['cc']) && (is_countable($this->addresses['cc']) ? count($this->addresses['cc']) : 0)) ? implode(', ', $this->addresses['cc']) : '';
		$bcc = (isset($this->addresses['bcc']) && (is_countable($this->addresses['bcc']) ? count($this->addresses['bcc']) : 0)) ? implode(', ', $this->addresses['bcc']) : '';
