...
//		$sessiondata['autologinid'] = (!$admin) ? (( $enable_autologin && $sessionmethod == SESSION_METHOD_COOKIE ) ? $auto_login_key : '') : $sessiondata['autologinid'];
	...
	setcookie($cookiename . '_data', serialize($sessiondata), ['expires' => $current_time + 31_536_000, 'path' => $cookiepath, 'domain' => $cookiedomain, 'secure' => $cookiesecure]);
...
function session_end($session_id, $user_id)
{
	...
	setcookie($cookiename . '_data', '', ['expires' => $current_time - 31_536_000, 'path' => $cookiepath, 'domain' => $cookiedomain, 'secure' => $cookiesecure]);
	setcookie($cookiename . '_sid', '', ['expires' => $current_time - 31_536_000, 'path' => $cookiepath, 'domain' => $cookiedomain, 'secure' => $cookiesecure]);
