  ...
  <div class="container-fluid forumline mx-0">
    ...
    <div class="row pt-1">
      ...
      <div class="col {postrow.ROW_CLASS} p-0">
        <div class="row">
          <div class="col"><img src="templates/BS_subSilver/images/icon_minipost.gif" alt="{L_POST}"><span class="postdetails">{L_POSTED}: {postrow.POST_DATE}&nbsp;&nbsp;&nbsp;&nbsp;{L_POST_SUBJECT}: {postrow.POST_SUBJECT}</span></div>
        </div>
