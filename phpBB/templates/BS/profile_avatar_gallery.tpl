...
<div class="p-2 text-center bg-light rounded-2 bdr-lt boxwrapper">
	<div class="row"> 
	  <div class="col py-2 navbr text-center">{L_AVATAR_GALLERY}</div>
	</div>
	<div class="row mx-0"> 
	  <div class="col hr1 py-2 text-center"><span class="genmed">{L_CATEGORY}:&nbsp;{S_CATEGORY_SELECT}&nbsp;<input type="submit" class="liteoption" value="{L_GO}" name="avatargallery" /></span></div>
	</div>
	<!-- BEGIN avatar_row -->
	<div class="row"> 
	<!-- BEGIN avatar_column -->
	...
	<!-- END avatar_row -->
	<div class="row hr1"> 
	  <div class="col text-center pt-1">{S_HIDDEN_FIELDS} 
