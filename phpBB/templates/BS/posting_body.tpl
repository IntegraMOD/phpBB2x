...
<div class="container-fluid">
  <div class="row">
	...
	<div class="p-2 mt-2 text-center bg-light rounded-2 bdr-lt boxwrapper">
	  <div class="row d-flex bg-body-secondary rounded-2 bdr-cat align-items-center py-1 mx-0 my-1"> 
	    <div class="col py-1 navbr">{L_POST_A}</div>
	  </div>
	  <div class="row d-flex bg-body-secondary rounded-2 bdr-cat align-items-center py-1 mx-0 my-1"> 
	    <div class="col">
		<!-- BEGIN switch_username_select -->
		<div class="row">
		  <div class="col-3 navbr">{L_USERNAME}</div>
		  <div class="col-9 genmed"><input type="text" class="post" tabindex="1" name="username" size="25" maxlength="25" value="{USERNAME}" /></div>
		</div>
		<!-- END switch_username_select -->
		<!-- BEGIN switch_privmsg -->  
		<div class="row">    
		  <div class="col-3 navbr">{L_USERNAME}</div>
		  <div class="col-9 genmed"><input type="text"  class="post" name="username" maxlength="25" size="25" tabindex="1" value="{USERNAME}" />&nbsp;<input type="submit" name="usersubmit" value="{L_FIND_USERNAME}" class="liteoption" onClick="window.open('{U_SEARCH_USER}', '_phpbbsearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" /></div>
		</div>
		<!-- END switch_privmsg -->
		<div class="row py-1">    
		  <div class="col-3 navbr">{L_SUBJECT}</div>
		  <div class="col-9 genmed"><input type="text" name="subject" size="45" maxlength="60" style="width:100%" tabindex="2" class="post" value="{SUBJECT}" /></div>
		</div>
		<div class="row hr1">   
		  <div class="col-3">
			<div class="row py-1">  
			  <div class="col navbr">{L_MESSAGE_BODY}</div>
			</div>
	        <div class="row d-flex bg-body-secondary rounded-2 bdr-cat align-items-center py-1 mx-0 my-1"> 
		      <div class="col">			
				<div class="row pt-2">  
				  <div class="col navbr text-center">{L_EMOTICONS}</div>
				</div>
				<!-- BEGIN smilies_row -->      
				<div class="row">
				  <!-- BEGIN smilies_col -->  
		  ...
		  <div class="col-9">
			...
			<div class="row"> 
			  <div class="col text-center mx-0 gen">
				<textarea name="message" rows="15" cols="35" wrap="virtual" style="width:95%" tabindex="3" class="post rounded-2" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{MESSAGE}</textarea>
			  </div>
			</div>
		  </div>
		</div>    
		<div class="row hr1">
		  <div class="col-3">
			<div class="row">
			  <div class="col navbr">{L_OPTIONS}</div>
			</div>
			<div class="row">
	  ...
	  <div class="row d-flex bg-body-secondary rounded-2 bdr-cat align-items-center py-1 mx-0 my-1"> 
	    <div class="col py-1 navbr">{POLLBOX}</div>
	  </div>
	  <div class="row d-flex bg-body-secondary rounded-2 bdr-cat align-items-center py-1 mx-0 my-1"> 
	    <div class="col">
