  ...
  <div class="row">
   ...
   <form method="post" action="{S_POST_DAYS_ACTION}">
      ...
      <div class="row mb-1 py-1 mx-0"> 
        <div class="col-10"><button class="btn fa- pb qb text-start"><i class="fa-solid fa-file-pen py-1"><a href="{U_POST_NEW_TOPIC}"><span class="btx nw"><img src="{POST_IMG}" alt="" />{L_BUTTON_TOPIC_NEW}</span></a></i></button>&nbsp;&nbsp;<span class="navbr text-end"><a href="{U_INDEX}">{L_INDEX}</a> -> <a href="{U_VIEW_FORUM}">{FORUM_NAME}</a></span></div>
        <div class="col"><span class="navbr text-end"><a href="{U_MARK_READ}">{L_MARK_TOPICS_READ}</a></span></div>
      </div>    	
