  ...
  <div class="row px-0"> 
	<div class="col">
        ...
        <div class="row mb-1 py-1 mx-0"> 
          <div class="col d-flex align-items-center"><a href="{U_POST_NEW_TOPIC}"><button class="btn fa- pb text-start"><i class="fa-solid fa-file-pen"><span class="px-2 btx">{L_BUTTON_TOPIC_NEW}</span></i></button></a>&nbsp;&nbsp;&nbsp;<a href="{U_POST_REPLY_TOPIC}"><button class="btn fa- pb text-start"><i class="fa-solid fa-file-signature"><span class="px-2 btx">{L_BUTTON_TOPIC_REPLY}</span></i></button></a>
        ...
        <div class="forumline p-0 mx-1">
        	...
        	<div class="row py-0 mx-0 row1"> 
        		...
        		<div class="col pt-2 pb-1 gen">
        				{postrow.PROFILE_IMG} {postrow.PM_IMG} {postrow.EMAIL_IMG} {postrow.WWW_IMG} {postrow.FB_IMG} {postrow.IG_IMG} {postrow.PT_IMG} {postrow.TWR_IMG} {postrow.SKP_IMG} {postrow.TG_IMG} {postrow.LI_IMG} {postrow.TT_IMG} {postrow.AIM_IMG} {postrow.YIM_IMG} {postrow.MSN_IMG}
     	...
     	<div class="row d-flex catBottom align-items-center text-center bdrw mx-0"> 
    	  <div class="col">
            ...
            <div class="col mx-0"><span class="gensmall">{L_DISPLAY_POSTS}: {S_SELECT_POST_DAYS}&nbsp;{S_SELECT_POST_ORDER}&nbsp;<input type="submit" value="{L_GO}" class="liteoption" name="submit" /></span></div>
            </form>
          </div>
    	</div>        	
      </div>
    ...
    <div class="row mx-0">
      <div class="col"><span class="navbr">{PAGE_NUMBER}</span><span class="gensmall text-end">{S_TIMEZONE}</span><br /><span class="navbr">{PAGINATION}</span></div>
           ...
           <div class="row pt-1 mx-0"> 
        	<div class="col-3"><span class="gensmall">{S_WATCH_TOPIC}</span><br /><br />
        	  {S_TOPIC_ADMIN}
        	</div>
