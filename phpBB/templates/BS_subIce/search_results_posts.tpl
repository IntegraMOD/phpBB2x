...
<div class="forumline">
  ...
  <div class="row mx-0 hr1"> 
	<div class="col catHead text-start pt-1"><span class="topictitle"><img src="templates/BS_subIce/images/folder.gif" align="absmiddle" />&nbsp; {L_TOPIC}:&nbsp;<a href="{searchresults.U_TOPIC}" class="topictitle">{searchresults.TOPIC_TITLE}</a></span></div>
  </div>
