      ...
      <div class="forumline px-0 m-2">
        <div class="bdrw">
    	  ...
    	  <div class="row mx-0 row1 hr1"> 
    	    ...
    	    <div class="col-1 px-0 text-center row2 hr3"><span class="postdetails">{topicrow.REPLIES}</span></div>
    	    <div class="col-2 px-0 text-center row3 hr3"><span class="name">{topicrow.TOPIC_AUTHOR}</span></div>
    	    <div class="col-1 px-0 text-center row2 hr3"><span class="postdetails">{topicrow.VIEWS}</span></div>
    	    <div class="col-2 px-0 text-start row3"><span class="postdetails">{topicrow.LAST_POST_TIME}<br />{topicrow.LAST_POST_AUTHOR} {topicrow.LAST_POST_IMG}</span></div>
    	  </div>
    	  <!-- END topicrow -->
