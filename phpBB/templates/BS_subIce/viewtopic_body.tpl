        ...
        <div class="forumline p-0 mx-1">
          ...
          <div class="row th hr1 mx-0 pt-1">
            ...
            <div class="row mx-0 row1 flex-nowrap"> 
              <div class="col-3 col-sm-2 hr4 pb-1"><span class="name"><a name="{postrow.U_POST_ID}"></a><b>{postrow.POSTER_NAME}</b></span><br /><span class="postdetails">{postrow.POSTER_RANK}<br />{postrow.RANK_IMAGE}{postrow.POSTER_AVATAR}<br /><br />{postrow.POSTER_JOINED}<br />{postrow.POSTER_POSTS}<br />{postrow.POSTER_FROM}</span><br /></div>
            ...
            <div class="row py-0 mx-0 row1"> 
              <div class="col-3 col-sm-2 pt-2 pb-1"><a class="navbr" href="#top" title="{L_BACK_TO_TOP}"><i class="fa-solid fa-circle-up fa-2x"></i></a></div>
