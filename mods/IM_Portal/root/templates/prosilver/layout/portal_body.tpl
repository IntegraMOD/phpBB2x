...
<!-- END center_blocks_row -->
	...
	<td valign="top" id="right_block" style="display: ''; width:200px">
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			<tr>
				...
				<td style="display: none;" width="10"><img src="{no_layout_collapse.SPACER}" alt="" width="10" height="30"></td>
...
<!-- BEGIN layout_collapse -->
	<td id="right_hide" style="display: none;" valign="top" align="right">
	     <a href="javascript:ShowHide('right_block','right_hide','right_block');">
	       <img src="{layout_collapse.LAYOUT_IMAGEL}" alt="" border="0">
	     </a>
	</td>
	<!-- END layout_collapse -->
	<!-- BEGIN no_layout_collapse -->
